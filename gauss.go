...
// Fraction Вывод в формате дробей решил сделать с помощью структуры, символизирующей собой дробь
...
// Перестраивает матрицу, чтоб на главной диагонали не было нулей
